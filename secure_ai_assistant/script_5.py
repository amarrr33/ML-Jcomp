# Create the text injection detector
text_injection_detector_code = '''"""
...
with open('text_injection_detector.py', 'w') as f:
    f.write(text_injection_detector_code)

print("✓ text_injection_detector.py created")